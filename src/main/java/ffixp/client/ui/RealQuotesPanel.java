 ...
 */
public class RealQuotesPanel extends JPanel {

    public RealQuotesPanel(RealQuotesTableModel realQuotesTableModel) {
        ...
        JTable table = new RealQuotesTable(realQuotesTableModel);
